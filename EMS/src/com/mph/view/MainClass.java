...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		try {
			BiPredicate<String, String> pred = (us, pw) -> us.equals("admin") && pw.equals("password");
			if (pred.test(un, ps))
			...
			do {
				...
				System.out.println("14. RS scroll sensitive");
				System.out.println("15. RS update");
				System.out.println("16. RS batchupdate");
